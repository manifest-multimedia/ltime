    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{url('/')}}"><img alt="logo" src="{{asset('assets/images/logo.png')}}" style="width:100px"> <span class="navbar-brand-name">{{__("Portal")}}</span></a>
            </div>
                    ...
                    <nav id="topbar">
                        ...
                        <ul class="list-unstyled menu-categories" id="topAccordion">
                            ...
                            <li class="menu single-menu active">
                                <a href="{{url('dashboard')}}" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle autodroprown">
                                    <div class="">
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                {{-- <li class="nav-item dropdown language-dropdown more-dropdown">
                    <div class="dropdown custom-dropdown-icon">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets/backend/assets/img/flag-us.svg')}}" class="flag-width" alt="flag">
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                            ...
                            <a class="dropdown-item" data-img-value="fr" data-value="fr" href="javascript:void(0);"><img src="{{asset('assets/backend/assets/img/fr.png')}}" class="flag-width" alt="flag"> French</a>
